// Mini Linter
// In this project, 
// you will use what you know about iterating over arrays to improve the quality of a paragraph.
// Also gather some information about that paragraph.
...
console.log(`You used "Really" ${reallyCnt} times, " Very" ${veryCnt} times, and "Basically" ${basicallyCnt} times.`);
  };
